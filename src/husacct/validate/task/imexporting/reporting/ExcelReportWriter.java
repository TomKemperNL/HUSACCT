...
public class ExcelReportWriter extends ReportWriter {
    ...
    public ExcelReportWriter(Report report, String path, String fileName, TaskServiceImpl taskServiceImpl) {
    	super(report, path, fileName, ExtensionTypes.XLS, taskServiceImpl);
    }
    ...
    private void writeStatistics(WritableSheet sheet) throws WriteException {
        ...
        numberOfAllDependencies_Total = numberOfAllDependencies_Import + numberOfAllDependencies_Declaration + numberOfAllDependencies_Call 
        ...
        numberOfAllDependencies_Direct = numberOfAllDependencies_Import_Direct + numberOfAllDependencies_Declaration_Direct + numberOfAllDependencies_Call_Direct 
        		+ numberOfAllDependencies_Access + numberOfAllDependencies_Inheritance_Direct + numberOfAllDependencies_Annotation_Direct 
        		+ numberOfAllDependencies_Reference_Direct;
        addCellNumber(sheet, 2, 6, numberOfAllDependencies_Direct);
        numberOfAllDependencies_Indirect = numberOfAllDependencies_Import_Indirect + numberOfAllDependencies_Declaration_Indirect + numberOfAllDependencies_Call_Indirect 
        		+ numberOfAllDependencies_Access_Indirect + numberOfAllDependencies_Inheritance_Indirect + numberOfAllDependencies_Annotation_Indirect 
        		+ numberOfAllDependencies_Reference_Indirect;
